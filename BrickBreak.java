...
public class BrickBreak extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        TimeLine timeLine = new TimeLine();//animations for sequential run
        ...
        GraphicsContext gc = canvas.getGraphicsContext2D(); //setting image 2D
